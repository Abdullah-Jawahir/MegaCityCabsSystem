...
public class BookingDAO {
    ...
    public List<Booking> getAllBookings() throws SQLException {
    	String query = "SELECT booking.*, customer.*, driver.*, vehicle.*, " +
                ...
                "user_driver.name AS driver_name, user_driver.password AS driver_password, " +
                ...
                "user_customer.name AS customer_name, user_customer.password AS customer_password, " +
