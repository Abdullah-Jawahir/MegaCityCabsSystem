...
<head>
    ...
    <link rel="stylesheet" href="<c:url value='/css/dashboard.css'/>">  <!-- Important for overall layout -->
    <link rel="stylesheet" href="<c:url value='/css/managePanel.css'/>"> <!-- Optional, if needed -->
