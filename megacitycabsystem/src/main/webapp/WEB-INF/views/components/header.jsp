...
<header class="top-header">
    <div id="header-search-container" class="header-search" style="display:none;">
...
document.addEventListener('DOMContentLoaded', function() {
    const allowedActions = ["manageCustomers", "manageBookings", "manageVehicles", "manageDrivers", "viewAssignDrivers"];
    ...
    allowedActions.forEach(action => {
        if (containsKeyword(currentPath, "admin?action=" + action)) {
            showSearchBar = true;
        }
    });
    ...
    // Existing search functionality - only executed if search bar is visible
    if (showSearchBar) {
